...
namespace UltimateTacticsDesigner.Designer
{
  ...
  public partial class MediaSlider : UserControl
  {
    ...
    private Color _clrBackColor = Color.FromArgb(255,255,0,0);
    ...
    {
      Rectangle trackRect = GetTrackRectangle();
      int width = Math.Max(1, (int)(Orientation == Orientation.Horizontal ? trackRect.Width * .1f : trackRect.Height * .1f));
      int height = Math.Max(1, this.TrackDepth);
